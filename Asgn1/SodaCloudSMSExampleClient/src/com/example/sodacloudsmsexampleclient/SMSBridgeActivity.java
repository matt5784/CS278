...
public class SMSBridgeActivity extends Activity implements AndroidSodaListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		final String server = ref.substring(0,ref.indexOf("|"));
	...
	public void connected(final AndroidSoda s) {
		...
		final ObjRef ref = ObjRef.fromObjUri(objRef_);
		final SMSListener l = soda_.get(SMSListener.class, ref);
		smsManager_.addListener(l);
	}

	@Override
	public void connectionFailure(final AndroidSoda s,
			final AndroidSodaConnectionException ex) {
